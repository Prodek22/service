...
const envSchema = z.object({
  ...
  CONTROL_CHECK_ENABLED: z.enum(['true', 'false']).default('false'),
  CONTROL_CHECK_CHANNEL_ID: z.string().default(''),
  CONTROL_CHECK_MANAGER_ROLE_IDS: z.string().default(''),
  CONTROL_CHECK_MANAGER_USER_IDS: z.string().default(''),
...
export const env = {
  ...
  CONTROL_CHECK_ENABLED: parsed.data.CONTROL_CHECK_ENABLED === 'true',
  CONTROL_CHECK_MANAGER_ROLE_IDS: splitList(parsed.data.CONTROL_CHECK_MANAGER_ROLE_IDS),
  CONTROL_CHECK_MANAGER_USER_IDS: splitList(parsed.data.CONTROL_CHECK_MANAGER_USER_IDS)
};
